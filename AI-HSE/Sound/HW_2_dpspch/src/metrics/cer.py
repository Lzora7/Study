...
class BeamSearchCERMetric(BaseMetric):
    """
    Calculate CER metric with Beam Search decoding
    """
...
class LibraryBeamSearchCERMetric(BaseMetric):
    """
    Calculate CER metric using library-based Beam Search decoding (pyctcdecode).
    ...
    def __call__(
        ...
        """
        Calculate CER using library-based beam search decoding.
